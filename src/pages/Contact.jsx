  ...
  return (
    <>
      <SEOHead
        ...
        description="Have a question about homeschooling? Reach out to the KingdomShift KingdomShift Homeschool Hub team. We'd love to hear from you."
        canonical="/contact"
      />
              ...
              <aside className="contact-info">
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <span>Join our free newsletter for weekly homeschool encouragement and resources</span>
                  </div>
                </div>
                  ...
                  <form className="contact-form" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={`form-group ${errors.message ? 'has-error' : ''}`}>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Tell us how we can help you on your homeschool journey…"
                      />
