    ...
    <footer className="footer">
      <div className="container footer__inner">
        <div className="footer__brand">
          <Link to="/" className="footer__logo">
            <BookOpen size={22} />
            <div>
              <div className="footer__logo-name">KingdomShift KingdomShift KingdomShift Homeschool Hub</div>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <p>© {year} KingdomShift KingdomShift KingdomShift Homeschool Hub. Built with <Heart size={13} className="footer__heart" /> for Kingdom families.</p>
